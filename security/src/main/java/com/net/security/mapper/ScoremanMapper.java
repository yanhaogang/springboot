...
public interface ScoremanMapper {
    ...
    @Select("select * from score_man where coun_id=#{arg0} and user_id=#{arg1}")
    @Results({
    ...
    List<Score> getAllbycauid(int arg0,int arg1);
    ...
    @Update("update score_man set score=0,is_scored=0 where coun_id=#{arg0} and index3_id=#{arg1}")
    void updateisscored(int arg0,int arg1);
